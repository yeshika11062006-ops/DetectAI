      ...
      <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <button className="flex items-center gap-2 rounded-2xl bg-cyan-500 px-6 py-4 font-semibold text-slate-900 transition hover:scale-105">
            ...
            <button className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-6 py-4 font-semibold text-white transition hover:bg-white/10">
